 ...
 */
final class Version20190818155514 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project DROP screenshot_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project ADD screenshot_id INT UNSIGNED DEFAULT NULL');
